      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-gradient-to-br from-primary-500 via-primary-600 to-purple-700 items-center justify-center p-12">
        ...
        <div className="relative text-white max-w-md">
          <h2 className="font-display text-3xl font-bold mb-4">
            {locale === 'zh' ? '让派对策划变得简单' : 'Party planning made simple'}
          </h2>
          <p className="text-primary-100 mb-8 leading-relaxed">
            {locale === 'zh'
              ? '创建精美邀请函，轻松管理宾客回复。'
              : 'Create beautiful invitations and manage guest RSVPs effortlessly.'}
          </p>
        ...
        >
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-[#fdf4ff] lg:bg-white px-4 text-neutral-400 font-medium tracking-wider">{t('login.orContinueWith')}</span>
            </div>
          </div>
