  ...
  return (
    <main className="flex-1 container mx-auto px-4 py-8">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Single Page Layout - Invitation First, then Guests, Stats, Photos */}
        <div className="flex flex-col gap-8">
          {/* 1. Invitation Section - Priority #1 */}
          ...
          {/* 2. Stats & Actions Section */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="md:col-span-2 grid grid-cols-3 gap-4">
              <div className="card text-center">
                <h3 className="text-xs md:text-sm font-semibold text-neutral-900 mb-1">{tr('totalInvited')}</h3>
                <div className="text-xl md:text-2xl font-bold text-neutral-900">{party.stats.total}</div>
              </div>
              <div className="card text-center">
                <h3 className="text-xs md:text-sm font-semibold text-neutral-900 mb-1">{tr('attending')}</h3>
                <div className="text-xl md:text-2xl font-bold text-green-600">{party.stats.attending}</div>
              </div>
              <div className="card text-center">
                <h3 className="text-xs md:text-sm font-semibold text-neutral-900 mb-1">{tr('responseRate')}</h3>
            ...
            <div className="grid grid-cols-2 md:grid-cols-1 md:flex md:flex-col gap-3">
              <button onClick={copyRsvpLink} className="btn btn-primary text-sm">
                {tr('copyLink')}
              </button>
