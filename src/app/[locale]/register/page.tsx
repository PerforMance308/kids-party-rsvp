        ...
        <div className="card">
          <div className="text-center mb-8">
            ...
            <p className="text-neutral-600 mt-2">
              Start planning amazing parties
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {/* Terms and Error message placed right above buttons */}
            <div className="space-y-3 pt-2">
              <div className={`flex items-start gap-2 p-3 rounded-lg border transition-colors ${!agreedToTerms && error ? 'bg-red-50 border-red-200' : 'bg-neutral-50 border-neutral-100'}`}>
                <input
                  type="checkbox"
                  id="terms"
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-white px-4 text-neutral-500 font-medium tracking-wider">Or continue with social account</span>
            </div>
          </div>
          ...
          <button
            ...
            className="w-full flex items-center justify-center px-4 py-3 border border-neutral-300 rounded-lg shadow-sm bg-white text-sm font-medium text-neutral-700 hover:bg-neutral-50 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500"
          >
