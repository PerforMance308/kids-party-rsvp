        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-neutral-600 mt-2">
              Manage your party invitations and RSVPs
            </p>
          </div>
          <Link href="/party/new" className="btn btn-primary">
            New Party
          </Link>
        </div>
        ...
        {parties.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-neutral-600 mb-6">
              Create your first party to start managing invitations and RSVPs
            </p>
            <Link href="/party/new" className="btn btn-primary">
                ...
                <div key={party.id} className="card hover:shadow-md transition-shadow">
                  ...
                  <div className="grid grid-cols-4 gap-2 mb-4 text-center">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-neutral-500">Maybe</div>
                    </div>
                  </div>

                  <div className="space-y-2">
                    <Link 
                      href={`/party/${party.id}/dashboard`}
                    ...
                    <div className="flex gap-2">
                      ...
                      <button 
                        onClick={() => {
                          if (window.confirm(`Are you sure you want to delete ${party.childName}'s party? This action cannot be undone.`)) {
                      ...
                      >
                        {deletingParty === party.id ? '⏳ Deleting...' : '🗑️ Delete'}
                      </button>
                    </div>
                  </div>
                </div>
